                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-sm-12">
                            ...
                            <h3>My name is John (Jef).</h3>
                            <h5 style="color: rgba(255, 255, 255, 0.6)">CREATIVE FRONT-END WEB DEVELOPER</h5>
                ...
                <div class="container clearfix">
                    <div class="row">
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            <p><img src="portfolio_1_screen_BASE/img/about.jpg" alt="" class="img-responsive img-circle"></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="portfolio_1_screen_BASE/img/portfolio-1.jpg" alt="" class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="portfolio_1_screen_BASE/img/portfolio-2.jpg" alt="" class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="portfolio_1_screen_BASE/img/portfolio-3.jpg" alt="" class="img-responsive"></a></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="portfolio_1_screen_BASE/img/portfolio-4.jpg" alt="" class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="portfolio_1_screen_BASE/img/portfolio-5.jpg" alt="" class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="portfolio_1_screen_BASE/img/portfolio-6.jpg" alt="" class="img-responsive"></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
